...
PACKAGE = "evia_journal"
STEPS = [
    ["analyze", "examples/nominal.json", "{out}/nominal.report.json"],
    ["store", "examples/nominal.json", "{out}/analysis.sqlite"],
    ["query", "{out}/analysis.sqlite", "{out}/sql-review.json"],
    [
        "verify",
        "{out}/analysis.sqlite",
        "local-session",
        "6ac24de383eeb71d1abb085b432196b270747954d7418f36cdbf13b12d29f2e2",
